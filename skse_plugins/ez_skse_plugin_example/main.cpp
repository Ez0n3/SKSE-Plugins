...
bool RegisterFuncs(VMClassRegistry* registry)
{
	registry->RegisterFunction(
		// EzSkseTestClass is defined in .\Data\Scripts\Source\EzSkseTestClass.psc
		new NativeFunction0 <StaticFunctionTag, bool>("Test", "EzSkseTestClass", Plugin_Example_Functions::Test, registry));
...
/*
// SKSE does not use this
__declspec(dllexport) SKSEPluginVersionData SKSEPlugin_Version = //int
{
};
*/
